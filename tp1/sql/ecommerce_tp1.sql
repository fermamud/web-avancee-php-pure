...
(2, 'Boucle d\'oreille', 'Magnifique boucle d\'oreille conçue par un artiste, après avoir passé un mois en Amazonie.', 40, 1, 2),
(3, 'Collier', 'Si votre place est la mer, cette belle pièce a été faite pour vous.', 50, 2, 1),
(4, 'Boucle d\'oreille', 'Boucle d\'oreille qui apporte l\'importance de l\'asymétrie et de la symétrie. Tout dépend de votre point de vue.', 62, 2, 1);
